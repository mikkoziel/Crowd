...
public class JsonInteractor {
    ...
    public JSONObject writeToJson(AppContent appContent) {
        return appContent.toJson();

    }

    public AppContent parseJSON(JSONObject object) throws JSONException {
        ...
        appContent.setGames(parseGames(object.getJSONArray("_games"), appContent));
    ...
    private ArrayList<Game> parseGames(JSONArray array, AppContent appContent) throws JSONException {
        ArrayList<Game> games = new ArrayList<>();
        for (int i = 0; i < array.length(); i++) {
            games.add(parseGame(array.getJSONObject(i), appContent));
        }
        return games;
    }
    ...
    private Game parseGame(JSONObject object, AppContent appContent) throws JSONException {
    ...
    private Answer parseAnswer(JSONObject object) throws JSONException {
        ...
        byte[] _image = parseArrayToBytes(object.get("_image"));
    ...
    private Question parseQuestion(JSONObject object) throws JSONException {
        ...
        String _image = object.getString("_image");
